...
for line in data:
    ...
    medianV = np.median(voltage)
    medianI = np.median(current)
...
# Plot 1: Ripple Voltage (top-left)
ax1 = axes[0, 0]
...
# Plot 3: Ripple Current (bottom-left)
ax3 = axes[1, 0]
...
# Plot 4: Mean Current (bottom-right)
ax4 = axes[1, 1]
