...
ax5.scatter(midpoint_rippleV, midpoint_rippleI, color='red', s=200, marker='*', 
            label='Midpoint', edgecolors='black', linewidth=2)
...
ax6.set_title('Distance from Midpoint', fontweight='bold')
